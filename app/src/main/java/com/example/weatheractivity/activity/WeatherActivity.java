...
import com.example.weatheractivity.util.ScreenShotUtils;
import com.example.weatheractivity.util.ShareUtils;
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(EditTextSeekString.length()==0){             //查询为空，给出提示信息
                            //RefreshTADList();
                            Toast.makeText(WeatherActivity.this,"查询值不能为空",Toast.LENGTH_LONG).show();
                        }
                        else{           //否则通过intent给查询界面传入查询的title
                            Intent intent = new Intent(WeatherActivity.this, com.example.weatheractivity.activity.search.class);
...
//    private void idqueryFromServer(final String type, final String weatherCode) {
//        showProgressDialog();
//        String url = "http://www.weather.com.cn/data/list3/city" + weatherCode + ".xml";
...
//                }
                Toast.makeText(WeatherActivity.this,"查询",Toast.LENGTH_SHORT).show();
                SearchDialog();
                break;
            case R.id.menu_left:

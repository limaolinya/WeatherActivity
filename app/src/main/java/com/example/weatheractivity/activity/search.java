...
import com.example.weatheractivity.model.CityList;
import com.example.weatheractivity.model.CityListAdapter;
import com.example.weatheractivity.service.AutoUpdateService;
...
import com.example.weatheractivity.util.HttpCallbackListener;
import com.example.weatheractivity.util.HttpUtil;
import com.example.weatheractivity.util.ToastUtil;
import com.example.weatheractivity.util.Utility;

public class search extends Activity implements SwipeRefreshLayout.OnRefreshListener, OnClickListener {
    ...
    String weatherid;
//    public final String weatherCode=weatherid;
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (x1 - x2 > 50 && temp.size() > 1) {
                            if (nonceCityIndex + 1 < temp.size()) {
                                ...
                                ToastUtil.showToast(search.this, "后面已经没有了 ☜", Toast.LENGTH_SHORT);
                            }
                        } else if (x2 - x1 > 50 && temp.size() > 1) {
                            if (nonceCityIndex - 1 >= 0) {
                                showWeather(temp.get(nonceCityIndex - 1));
                            } else {
                                ToastUtil.showToast(search.this, "☞ 前面已经没有了", Toast.LENGTH_SHORT);
                            }
                        }
                        break;
                }
...
//        about.setOnClickListener(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherid = extras.getString("tranTitletoRE");      //接受主界面传来的title值
        Log.d("..",weatherid);
        ...
        if (!TextUtils.isEmpty(countyCode)) {
            ...
            if (isFirstAddCity == 1) {
                ...
                alert = null;
                builder = new AlertDialog.Builder(search.this, android.R.style.Theme_Material_Light_Dialog_Alert);
...
//        countyCode = weatherid;
//        String address = "http://www.weather.com.cn/data/list3/city" + countyCode + ".xml";
        String address = weatherid;
...
//        String address = "http://wthrcdn.etouch.cn/weather_mini?citykey=" + weatherCode;
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                if ("countyCode".equals(type)) {
                    ...
                    // 处理服务器返回的天气信息
                    final String city = Utility.handleWeatherResponse(search.this, response);
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            closeProgressDialog();
                            ToastUtil.showToast(search.this, "天气已是最新  \\(^o^)/~", Toast.LENGTH_SHORT);
            ...
            public void onError(Exception e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        ToastUtil.showToast(search.this, "Duang~ 没网了", Toast.LENGTH_SHORT);
                    }
                });
            }
        });
    ...
    public void onRefresh() {
        ...
        if (!TextUtils.isEmpty(weatherCode)) {
            ...
            ToastUtil.showToast(search.this, "☜ 亲！先添加一个城市吧", Toast.LENGTH_SHORT);
            swipe_container.setRefreshing(false);
        }
    }
...
//                }
                Toast.makeText(search.this,"查询",Toast.LENGTH_SHORT).show();
...
//                break;
    ...
    private void updateCityList(String cityName, String weatherCode) {
        if (cityName != null && weatherCode == null) {
            ...
            CityListAdapter adapter = new CityListAdapter(search.this, R.layout.citylist_item, cities);
